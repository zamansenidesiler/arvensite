const tr = {
  ...
  "trust": {
    ...
    "messages": [
      {
        "role": "client",
        "text": "Merhaba! Ekibim için özel çete kıyafeti istiyorum 🔥"
      },
      {
        "role": "support",
        "text": "Harika bir tercih! Hangi tema veya konsept üzerinde düşünüyorsunuz?"
      },
      {
        "role": "client",
        "text": "Sokak modası ağırlıklı, 6 farklı karakter için kombin set lazım."
      },
      {
        "role": "support",
        "text": "Anlıyorum! Sıfırdan, tamamen özgün ve FPS dostu tasarımlar yapıyoruz. Discord'dan hemen başlayalım mı? 💜"
      }
    ],
    "stats": [
      {
        "value": "200+",
        "label": "Tamamlanan Tasarım",
        "desc": "Her biri özgün konseptle sıfırdan üretildi.",
        "glow": "rgba(245,158,11,0.18)"
      },
      {
        "value": "%100",
        "label": "FPS Optimize",
        "desc": "LOD desteğiyle sunucu performansı etkilenmez.",
        "glow": "rgba(251,191,36,0.14)"
      },
      {
        "value": "7/24",
        "label": "Discord Destek",
        "desc": "Sorunuz olduğunda her zaman ulaşabilirsiniz.",
  ...
  "reviews": {
    ...
    "items": [
      {
        "author": "Reese",
        "text": "En iyi kalite, kolay kurulum ve optimize. Destek harika!"
      },
      {
        "author": "Blitzkrieg",
        "text": "Üst düzey destek. Kalite mükemmel, FPS dostu tasarımlar."
      },
      {
        "author": "BIG J-ROCC",
        "text": "Güvenilir ve profesyonel. Kesinlikle tavsiye ederim."
      },
      {
        "author": "Luks",
        "text": "Gördüğüm en iyi FiveM giysi kalitesi. Çok memnun kaldık."
      },
      {
        "author": "nestea",
        "text": "Sorunsuz teslimat, hızlı ve samimi destek ekibi."
      },
      {
        "author": "Spalato",
        "text": "Profesyonel ekip, her soruya anında dönüş. 10/10!"
      },
      {
        "author": "Chais",
        "text": "tek kelimeyle mükemmel 10/10"
      }
    ]
  },
  "services": {
    ...
    "steps": [
      {
        "num": "01",
        "title": "İletişime Geç",
        "desc": "Giysi konseptiniz ve referans görsellerinizle Discord üzerinden bana ulaşın."
      },
      {
        "num": "02",
        "title": "Görüş ve Fiyat",
        "desc": "Gereksinimlerinizi konuşup şeffaf bir fiyat teklifi sunarım."
      },
      {
        "num": "03",
        "title": "Tasarla ve Oluştur",
        "desc": "Düzenli ilerleme güncellemeleriyle giysinizi oluştururum."
      },
      {
        "num": "04",
        "title": "Teslim",
        "desc": "FiveM sunucunuza hazır bitmiş dosyaları teslim alırsınız."
      }
    ]
  },
  "pricing": {
